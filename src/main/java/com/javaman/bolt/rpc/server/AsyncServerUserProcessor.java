...
public class AsyncServerUserProcessor extends AsyncUserProcessor<RequestBody> {
    ...
    class InnerTask implements Runnable {
        ...
        public void run() {
            ...
            try {
                RpcServerDemoByMain.server.getRpcServer().invokeSync(remoteAddr, new RequestBody(1, "88888888"), 234234);
            ...
            if (isException) {
                ...
                if (!delaySwitch) {
                    this.asyncCtx.sendResponse(new RequestBody(1, "Hello world"));
                    return;
                }
                try {
                ...
                this.asyncCtx.sendResponse(new RequestBody(1, "666666"));
            }
