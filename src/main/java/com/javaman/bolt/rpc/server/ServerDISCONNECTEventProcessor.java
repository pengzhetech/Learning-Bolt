 ...
 */
public class ServerDISCONNECTEventProcessor implements ConnectionEventProcessor {

    static Logger logger = LoggerFactory.getLogger(ServerDISCONNECTEventProcessor.class);
